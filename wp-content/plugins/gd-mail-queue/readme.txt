...
Version: 4.3
Tags: dev4press, queue, email log, smtp, html email
...
== Changelog ==
= 4.3 - 2024.05.08 =
* New: plugin tested with WordPress up to 6.5
* New: plugin tested with PHP up to 8.3
* New: system requirements: plugin requires PHP 7.4
* New: system requirements: plugin requires WordPress 5.8
* New: changes related to WordPress and PHP code standards
* New: function `json_encode` replaced with `wp_json_encode`
* Edit: d4pLib 2.8.17
* Fix: intercepted email subject encodes `&` character
* Fix: getting version number from PHPMailer for email test
* Fix: few minor issues related to an older shared library version

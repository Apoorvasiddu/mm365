...
<div class="d4p-group d4p-group-import d4p-group-about">
    ...
    <div class="d4p-group-inner">
        <ul>
            <li><?php esc_html_e( 'On WordPress.org', 'gd-mail-queue' ); ?>:
                <span><a href="https://wordpress.org/plugins/gd-mail-queue/" target="_blank">wordpress.org/plugins/gd-mail-queue</a></span></li>
            <li><?php esc_html_e( 'On Dev4Press', 'gd-mail-queue' ); ?>:
                <span><a href="https://plugins.dev4press.com/gd-mail-queue/" target="_blank">plugins.dev4press.com/gd-mail-queue</a></span></li>
        </ul>
    </div>
</div>

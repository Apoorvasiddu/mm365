    ...
    <div class="d4p-content">
        <div class="d4p-content-left">
            <div class="d4p-panel-title">
                ...
                <h3><?php esc_html_e( 'Installation', 'gd-mail-queue' ); ?></h3>
            </div>
            <div class="d4p-panel-info">
				<?php esc_html_e( 'Before you continue, make sure plugin installation was successful.', 'gd-mail-queue' ); ?>
            </div>
        </div>
        <div class="d4p-content-right">
            <div class="d4p-update-info">
				...
				esc_html_e( 'Installation completed.', 'gd-mail-queue' );

                ...
                <table class="ina-form-tbl form-table">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description"><?php esc_html_e( 'Limited to 24 hours i.e 1440 minutes.', 'inactive-logout' ); ?> If these timeouts are not working for you then, <a target="_blank" href="https://inactive-logout.com/blog/some-things-to-consider-when-using-inactive-logout/">read this post.</a></p>
                        </td>
                    </tr>

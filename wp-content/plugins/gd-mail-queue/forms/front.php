    ...
    <div class="d4p-plugin-dashboard">
        <div class="d4p-content-left">
            ...
            <div class="d4p-buttons-group">
                <a class="button-secondary" href="admin.php?page=gd-mail-queue-settings"><i aria-hidden="true" class="fa fa-cogs fa-fw"></i> <?php esc_html_e( 'Settings', 'gd-mail-queue' ); ?>
                </a>
                <a class="button-secondary" href="admin.php?page=gd-mail-queue-tools"><i aria-hidden="true" class="fa fa-wrench fa-fw"></i> <?php esc_html_e( 'Tools', 'gd-mail-queue' ); ?>
                </a>
            </div>

            <div class="d4p-buttons-group">
                <a class="button-secondary" href="admin.php?page=gd-mail-queue-about"><i aria-hidden="true" class="fa fa-info-circle fa-fw"></i> <?php esc_html_e( 'About', 'gd-mail-queue' ); ?>
                </a>
            </div>
        </div>

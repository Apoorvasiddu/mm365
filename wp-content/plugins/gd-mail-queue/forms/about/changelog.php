...
<div class="d4p-group d4p-group-changelog">
    ...
    <div class="d4p-group-inner">
        <h4>Version: 4.3 / may 8 2024</h4>
        <ul>
            <li><strong>new</strong> plugin tested with WordPress up to 6.5</li>
            <li><strong>new</strong> plugin tested with PHP up to 8.3</li>
            <li><strong>new</strong> system requirements: plugin requires PHP 7.4</li>
            <li><strong>new</strong> system requirements: plugin requires WordPress 5.8</li>
            <li><strong>new</strong> changes related to WordPress and PHP code standards</li>
            <li><strong>new</strong> function `json_encode` replaced with `wp_json_encode`</li>
            <li><strong>edit</strong> d4pLib 2.8.17</li>
            <li><strong>fix</strong> intercepted email subject encodes `&` character</li>
            <li><strong>fix</strong> getting version number from PHPMailer for email test</li>
            <li><strong>fix</strong> few minor issues related to an older shared library version</li>
        </ul>

        <h4>Version: 4.2.1 / august 9 2023</h4>
        <ul>
            <li><strong>edit</strong> improved the function for detecting HTML tags in content</li>
            <li><strong>fix</strong> duplicated merge of the KSES wide tags and attribute lists</li>

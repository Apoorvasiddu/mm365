...
//$council = $_REQUEST['council'] ?? 'mmsdc';

$css_class = !empty($args['css_class']) ? esc_attr( $args['css_class'] ) : 'border-0';
$form_title = ! empty( $args['form_title'] ) || $args['form_title']=='0' ? esc_attr__( $args['form_title'], 'userswp' ) : __( 'Please Login', 'userswp' );
...
<h4 class="heading-medium text-center" style="color: #1e73be;">Already registered your company?</h4><br/>
<div class="row">
                ...
                <div class="uwp-footer-links">
                    <div class="uwp-footer-link d-inline-block">
						...
						echo aui()->button(array(
							...
							'content'    => __( '<span>Not registered?</span> Create an account', 'userswp' ),

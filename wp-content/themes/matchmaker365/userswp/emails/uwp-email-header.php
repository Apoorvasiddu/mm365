    ...
    <body <?php echo is_rtl() ? 'rightmargin' : 'leftmargin'; ?>="0" marginwidth="0" topmargin="0" marginheight="0" offset="0">
        <div id="wrapper" dir="<?php echo is_rtl() ? 'rtl' : 'ltr'?>">
            <table border="0" cellpadding="0" cellspacing="0" height="100%" class="wrapper-table">
				...
				<tr style="background-color: #0078d4 !important;">
                            ...
                            <tr>
                                <td align="center" valign="top">
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" id="email_body">
                                        <tr><td><img src="<?php echo site_url(); ?>/wp-content/themes/matchmaker365/assets/images/email-header-MMSDC.png" alt="MMSDC Logo" style="border: 0; display: block; height: auto; width: 380px;margin-top:0px;margin-left: 30px;"></td></tr>
                                        <tr>

...
<h4 class="heading-medium text-center" style="color: #1e73be;">Get started with
MatchMaker365</h4><br/>
    <div class="row">
        <div class="card mx-auto container-fluid p-0 <?php echo $css_class; ?>" >
            ...
            <div class="card-body">
				...
				<h6 style="text-align: center; color: #555; font-weight: 300; padding:0 20px; font-size:14px">Please enter the following information to create your account.</h6>

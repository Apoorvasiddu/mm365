<?php
/**
 * Template Name: Council Manager Reports - Company Registartion
 *
 */
...
<div class="dashboard">
  ...
  <div class="dashboard-content-panel">
    ...
    <form method="post" id="mm365_generate_report_comapny" action="" data-parsley-validate
      ...
      <section class="company_preview">
        ...
        <div class="form-row form-group">
          ...
          <div class="col-lg-4">
            <input type="hidden" id="council_filter" name="council_filter"
              value="<?php echo esc_html(apply_filters('mm365_helper_get_usercouncil',$user->ID)); ?>">
          </div>
        </div>
        <div class="form-row form-group">
          <div class="col-lg-12"><label><small>*Maximum duration between From date and To date is limited to 1
        ...
        <div class="form-row form-group">
          ...
          <div class="col-lg-4" id="mc-block"
            data-intro="Minority classification of the company which the buyer prefers"  style="margin-top: 15px;">
      ...
      <div class="form-row mto-30">
        <div class="col-lg-12 text-right">
          <?php wp_nonce_field('mm365-report-company', 'companyreportnonce'); ?>
          <input type="hidden" name="action" value="mm365-generate-report-companyreg">
          <button data-intro="Download report with all data in XLS format." type="submit" name="download-sbt"
            id="download-report" class="btn btn-primary">

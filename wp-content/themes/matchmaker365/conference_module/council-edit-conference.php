...
<form method="post" id="mm365_council_update_conference" action="#"  data-parsley-validate enctype="multipart/form-data" >
   <div class="row">
     <!-- Left part -->
     <div class="col-6" data-intro="Full name of the council">
        ...
        <div class="form-row form-group">
         ...
         <input placeholder="Please add requirement title" class="form-control"  type="text" required name="conference_title" id="conference_title" pattern="/^[a-zA-Z-\s']+$/" minlength="4" value="<?php
            echo $title;
         ?>"> 
        </div>
        ...
        <div class="form-row form-group">
         <div class="col-12">
          ...
          <textarea placeholder="Short description" class="form-control"  type="text" required name="conference_description" id="conference_description"  data-parsley-errors-container=".conferece_description_error">
            <?php
                echo $content;
            ?>
          </textarea>
        ...
        <div class="form-row form-group">
            <div class="col-12">
                        ...
                        <select name="participating_buyers[]" data-conf_id="<?php echo esc_html($conf_id); ?>" id="participating_buyers" multiple required class="form-control" data-parsley-errors-container=".participating_buyers_error"></select>
       ...
       <div class="form-row form-group">
            <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="text" name="conference_date" id="" class="meeting_date_1 form-control " required placeholder="" data-parsley-errors-container=".meeting_date_error" value="<?php
                                echo $conf_date;
                            ?>">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="text" name="conference_starttime" id="" class="from_time_1 form-control" required placeholder="" data-parsley-errors-container=".from_time_1_error" 
                            value="<?php
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="text" name="conference_endtime" id="" class="to_time_1 form-control" required placeholder="" data-parsley-errors-container=".to_time_1_error"
                            value="<?php
                                echo $conf_end_time;
                            ?>" >
        ...
        <div class="form-row form-group">
            <div class="col-6">
                        ...
                        <input type="text" name="meeting_venue" required id="" class=" form-control " required placeholder="" data-parsley-errors-container=".first_choice_error"
                        value="<?php
                                echo $conf_venue;
                            ?>" >
            </div>
            <div class="col-6">
                        ...
                        <input type="url" name="map_link"  id="" class=" form-control "  placeholder="" data-parsley-errors-container=".first_choice_error"  value="<?php
                                echo $conf_map_link;
                            ?>" >
            </div>
        </div>
        ...
        <div class="form-row form-group">
            ...
            <div class="col-5">
                        ...
                        <input type="text" name="registration_closing_date" id="" class="form-control registration_closing_date" required placeholder="" data-parsley-errors-container=".registration_closing_date_error" value="<?php  echo $conf_registration_closing_date; ?>">
                        <div class="registartion_closing_date_error"></div>  
            </div>
        </div>

        <div class="pto-30">
         <h5>Organizing Team</h5><hr>
        </div>
        <div class="form-row form-group">
            <div class="col-12">
                        <label for="">Council Managers<span>*</span></label>
                        <select data-conf_id="<?php echo esc_html($conf_id); ?>" name="fellow_council_managers[]" id="fellow_council_managers" multiple required class="form-control" data-parsley-errors-container=".fellow_council_managers_error"></select>
        ...
        <div class="form-row form-group">
            <div class="col-6">
                        ...
                        <input type="text" name="primary_contact_person" id="" class=" form-control " required placeholder="" value="<?php echo $conf_primary_contact_person; ?>">
            </div>
            <div class="col-6">
                        <label for="">Phone Number<span>*</span></label>
                        <input type="text" name="contact_phone_number" id="" class=" form-control " required placeholder="" pattern="[0-9+()\s]+" data-parsley-length="[6, 15]" value="<?php echo $conf_contact_phone_number; ?>">
            </div>
        </div>
   ...
   <div class="form-row pto-10">
      <div class="col text-right">
          ...
          <input type="hidden" name="update_conf_id" id="update_conf_id" value="<?php echo esc_html( $conf_id ); ?>" />
          <input type="hidden" id="after_success_redirect" name="after_success_redirect" value="<?php echo esc_url(site_url()."");?>">
          <button id="council_create_conf" type="submit" class="btn btn-primary" ><?php _e('Update & Preview', 'mm365') ?></button>
      </div>
  </div>
  </form>

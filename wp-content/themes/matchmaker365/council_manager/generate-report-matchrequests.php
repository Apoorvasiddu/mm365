<?php
/**
 * Template Name: Council Manager Reports - Match requests
 *
 */
...
if (!empty($_POST)):
  ...
  if (isset($from) and isset($to)) {
    //Mention the slug on this page to get redirect up on error
    apply_filters('mm365_admin_filteredreports_matchrequests','council-manager-report-match-requests'); 
  }
endif;
    ...
    <form method="post" id="mm365_generate_report_matchrequests" action="" data-parsley-validate
      ...
      <section class="company_preview">
        ...
        <div class="form-row form-group">
          ...
          <div class="col-lg-4">
            ...
            <input type="hidden" id="councilFilter" name="council_filter"
      ...
      <div class="form-row mto-30">
        <div class="col-lg-12 text-right">
          <?php wp_nonce_field('mm365-report-matchrequests', '_matchrequestsnonce'); ?>

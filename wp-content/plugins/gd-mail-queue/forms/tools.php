...
$panels = array(
	...
	'export'  => array(
		'title'       => __( 'Export Settings', 'gd-mail-queue' ),
		'icon'        => 'download',
		'break'       => __( 'Export / Import', 'gd-mail-queue' ),
		'button'      => 'button',
		'button_text' => __( 'Export', 'gd-mail-queue' ),
		'info'        => __( 'Export all plugin settings into file.', 'gd-mail-queue' ),
	),
	'import'  => array(
		'title'       => __( 'Import Settings', 'gd-mail-queue' ),
		'icon'        => 'upload',
		'button'      => 'submit',
		'button_text' => __( 'Import', 'gd-mail-queue' ),
		'info'        => __( 'Import all plugin settings from export file.', 'gd-mail-queue' ),
	),
	'remove'  => array(
		'title'       => __( 'Reset / Remove', 'gd-mail-queue' ),
		'icon'        => 'remove',
		'break'       => __( 'Reset Plugin', 'gd-mail-queue' ),
		'button'      => 'submit',
		'button_text' => __( 'Remove', 'gd-mail-queue' ),

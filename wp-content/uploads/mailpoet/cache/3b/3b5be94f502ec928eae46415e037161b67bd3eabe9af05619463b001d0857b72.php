...
/* newsletters.html */
class __TwigTemplate_991d5c797ab04c59c798743e0479202f27be2a5c5c4bb32837d4a1515dca408e extends \MailPoetVendor\Twig\Template
{
    private $source;
    private $macros = [];
  ...
  <script type=\"text/javascript\">
    ";
      ...
      var mailpoet_account_url = '";
        // line 36
        echo \MailPoetVendor\twig_escape_filter($this->env, $this->extensions['MailPoet\Twig\Functions']->addReferralId(((("https://account.mailpoet.com/?s=" . ($context["subscriber_count"] ?? null)) . "&email=") . \MailPoetVendor\twig_get_attribute($this->env, $this->source, ($context["current_wp_user"] ?? null), "user_email", [], "any", false, false, false, 36))), "js");
        echo "';
...
";
    ...
    {
        return new Source("", "newsletters.html", "C:\\xampp\\htdocs\\testmmsdcmm\\wp-content\\plugins\\mailpoet\\views\\newsletters.html");
    }
}

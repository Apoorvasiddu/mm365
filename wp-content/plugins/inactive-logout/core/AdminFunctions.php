...
class AdminFunctions {
	...
	public function saveRoleBasedSettings() {
		...
		$ina_popup_behaviour                  = filter_input( INPUT_POST, 'ina_popup_behaviour', FILTER_SANITIZE_NUMBER_INT );
		...
		if ( $idle_timeout ) {
			...
			Helpers::update_option( '__ina_popup_behaviour', $ina_popup_behaviour );

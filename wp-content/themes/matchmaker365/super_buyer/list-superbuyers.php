<?php
/**
 * Template Name: Super Admin - List Super Buyers
 *
 */
...
<section class="row admin-dash-filter">
    <div class="col-12"><h3 class="heading-large">List Super Buyers</h3></div>
</section>
...
<table id="superadmin_list_council_managers" class="mm365datatable-list table table-striped"  cellspacing="0" width="100%" data-intro="List of council managers">
  <thead class="thead-dark">
    <tr>
      <th class="no-sort" data-intro="Manager's name"><h6>Super Buyer</h6></th>
      ...
      <th class="no-sort" data-intro="Edit Super Buyer"><h6></h6></th>
    </tr>
  </thead>
  <tbody>
  
  <?php
  $users  = get_users( array( 'role__in' => array( 'super_buyer') ) );
  foreach ($users as $key => $value) {
    ...
    <tr>
      ...
      <td><?php echo esc_html(get_user_meta($value->ID, '_mm365_superbuyer_phone', true )); ?></td>
      ...
      <td><a href="<?php echo add_query_arg( '_wpnonce', wp_create_nonce( 'sa_edit_superbuyer' ), site_url().'/edit-superbuyer?cmu='.esc_html($value->ID)); ?>">EDIT</a></td>
    </tr>
<?php
  }
?>

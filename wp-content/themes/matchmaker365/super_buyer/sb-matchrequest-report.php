<?php
/**
 * Template Name: SB - Matchrequest Report
 *
 */
...
if (!empty($_POST)):
    ...
    if (isset($from) and isset($to)) {
        //Mention the slug on this page as function param to get redirected on error
        apply_filters('mm365_admin_filteredreports_matchrequests','sb-matchrequest-report'); 
    }
endif;
...
<div class="dashboard">
    ...
    <div class="dashboard-content-panel">
        <h2 class="heading-large">Match Request Report</h2>
        ...
        <?php endif; ?>
        <!-- Report Generation Form -- Repurposed from Council manager reports -->
        <form method="post" id="mm365_generate_report_matchrequests" action="" data-parsley-validate
            ...
            <section class="company_preview">
                ...
                <div class="form-row form-group">
                    ...
                    <div class="col-lg-3" data-intro="Maximum duration between From date and To date is one year">
                    ...
                    <div class="col-12 d-block d-sm-none pbo-30"></div>
                    <div class="col-lg-3" data-intro="Status of the match requests at the time of report generation">
                        <label for="">Match status</label>
                        <select required data-parsley-errors-container=".match_statusError" name="match_status"
                            id="match_status" class="form-control mm365-single">
                        ...
                        <div id="closurefilter-block">
                            ...
                            <select name="match_closure_filter" id="match_closure_filter_completed"
                            ...
                            <select name="match_closure_filter" id="match_closure_filter_cancelled"
                                class="form-control mm365-single">
                                <option value="">-Select-</option>
                                <?php
                    ...
                    <div class="col-lg-3" data-intro="Buyer Team Members">

                        <label for="">My Team Members</label>
                        <select required data-parsley-errors-container=".match_statusError" name="my_team_member"
                            id="my_team_member" class="form-control mm365-single">
                            <option value="all">All</option>
                            <?php
                            foreach (get_user_meta($user->ID, '_mm365_associated_buyer') as $cmp_id) {
                                echo "<option value='" . $cmp_id . "'>" . get_the_title($cmp_id) . " (" . get_post_meta($cmp_id, 'mm365_contact_person', true) . ")</option>";
                            }
                            ?>
                ...
                <div class="form-row form-group">
                    ...
                    <div class="col-lg-4" data-intro="Minority classification of the company which the buyer prefers"  style="margin-top: 15px;">
                        <label for="">Minority classification</label>
                        <select required data-parsley-errors-container=".minority_categoryError"
                            name="minority_category" id="minority_category" class="form-control mm365-single">
                            <option value="all">-Select-</option>
                            <option value="all">All</option>
              ...
              apply_filters('mm365_dropdown_countries', [])
                ...
                <div class="form-row form-group">
                    ...
                    <div class="col-lg-4"
                        ...
                        <select name="certifications[]" id="certifications" class="form-control mm365-multicheck"
                            multiple>
                            <?php
                ...
                <div class="form-row form-group">
                    <!-- <div class="col-lg-4"
                        ...
                        <section class="naics-codes">
                            <div class="form-row  form-group">
                                <div class="col">
                                    <input class="form-control mr-naic" type="number" min="10" max="999999"
                                        name="naics_codes[]">
                                </div>
                        ...
                        <a class="external_link" target="_blank" href="https://www.naics.com/search/"><span>Search for
                                NAICS
                                code</span> &nbsp;<img
                                src="<?php echo get_template_directory_uri() ?>/assets/images/share.svg" alt=""></a>
                    ...
                    <div class="col-lg-4"
                        ...
                        <label for="">Looking for international assistance<br /><small>International assistance offered
                                by
                                council</small></label>
                ...
                apply_filters('mm365_dropdown_internationalassistance', [])
                  ?>
                    ...
                    <div class="col-lg-4">
                        <?php
                        foreach (get_user_meta($user->ID, '_mm365_associated_buyer') as $cmp_id) {
                            echo '<input type="hidden"  name="associated_buyers_list[]" value="' . $cmp_id . '">';
                        }
                        ?>
                    </div>
                </div>
            ...
            <div class="form-row mto-30">
                <div class="col-lg-12 text-right">
                    <?php wp_nonce_field('mm365-report-sb-matchrequests', '_matchrequestsnonce_sb'); ?>
                    <input type="hidden" name="action" value="mm365_generate_report_matchrequests">
                    <button data-intro="Download report with all data in XLS format." name="download-sbt"
                        id="download-report-mr" class="btn btn-primary">
                    ...
                    <button data-intro="View the report on screen with limited data" name="view-sbt"
                        ...
                        class="btn btn-primary"><?php _e('View Report', 'mm365') ?></button>

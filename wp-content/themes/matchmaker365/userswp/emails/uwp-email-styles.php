...
$header_bg       		= uwp_get_option( 'email_header_background_color', '#f5f5f5' );
$header_color 			= uwp_get_option( 'email_header_text_color', '#ffffff' );
$header_bg_darker_10 	= uwp_hex_darker( $header_bg, 10 );

$footer_bg      		= uwp_get_option( 'email_footer_background_color', '#f5f5f5' );
$footer_color 			= uwp_get_option( 'email_footer_text_color', '#f5f5f5' );
...
#template_body {
    ...
    border: 0px solid <?php echo esc_attr( $bg_darker_10 ); ?>;
    border-radius: 3px !important;
	box-shadow: 0 1px 4px rgba(0,0,0,0.1) !important;
}
#template_header {
	background-color: none;
	border: 0px solid <?php echo esc_attr( $header_bg_darker_10 ); ?>;
	padding: 15px;
}
#template_header,
#template_header a {
...
#template_footer {
	background-color: none;
	border: 0px solid <?php echo esc_attr( $footer_bg_darker_10 ); ?>;
    text-align:center;
